...
angular.module('app').controller('AppController', function($scope, $http) {
  ...
  $scope.search = function() {
    ...
    // Foursquare api keys
    // do not remove " "
    var clientID = "HZKZ0NBOYSEE2R4AFRS45BFZ25RBWPQAI4OLHI04CULUU5QH";
    var clientSecret = "&client_secret=KK0JT42RYO50NO3UKSFF4CSHOYTKZI2TXHRQXHFNSNKTLGOV";

    $http.get("https://api.foursquare.com/v2/venues/explore/?near=" + $scope.obj.searchString + "&venuePhotos=1&section=" + category.join(',') + "&client_id=" + clientID + "" + clientSecret + "&v=20131124")
...
angular.module('app').controller('DetailController', function($scope, $http) {
  ...
  // Foursquare api keys
    // do not remove " "
    var clientID = "HZKZ0NBOYSEE2R4AFRS45BFZ25RBWPQAI4OLHI04CULUU5QH";
    var clientSecret = "KK0JT42RYO50NO3UKSFF4CSHOYTKZI2TXHRQXHFNSNKTLGOV";
